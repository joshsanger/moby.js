	...
	<article class="content">
			...
			<section class="no-separator" id="getting-started">
				<div class="container">
					...
					<div class="wrap">
						<p>You can <a href="<?php echo BASE_URL;?>/downloads/moby2.0.7.zip">download</a> the files, or simply include Moby.js in your project by using <a href="https://bower.io/" target="_blank">Bower</a> install.</p>
<pre>
